...
/**
 * Цей клас використовуватися для викидання винятків при невдалій валідації даних та передачі
 * помилок обробнику помилок для подальшої обробки або відображення користувачу
 */
