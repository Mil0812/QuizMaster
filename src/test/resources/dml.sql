...
VALUES ('ce66389c-ab6e-42d8-aa79-b6b9abf41cdb', 'lollipop321', 'lily098', 'Фанні',
        'Марвен',
        'lollipop@i.ua', 'student'),
       ('93966090-3acc-41c2-a88c-1808fbcb60a1', 'millennium', 'Mmm7', 'Міа', 'Лейм',
...
INSERT INTO test(id, section_id, author_id, type_id, title, image, question_count)
VALUES ('b3566029-3256-466a-8582-de168fe65d04', '43997949-68b8-4731-8105-ad81280488d8',
        '3b5a1d93-6a0b-42c1-b1c8-25caedec9fe9', '372a768e-a0e1-4f60-9fcc-6579eb82bc0c',
        'Основи Access', NULL, 3),
       ('b445b3da-f6e8-4307-a007-b7563bfa253a', 'c6091036-3bc7-41ae-a01f-2e8d1b66d123',
        'e969b133-c007-419b-bd64-3fbba78ecb2d', 'd4e83df7-0b97-45df-a2f1-f85eba2fcf5f',
        'SQL-запити: база', NULL, 2);
