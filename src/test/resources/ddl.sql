...
(
    id             BINARY(36) PRIMARY KEY,
    section_id     BINARY(36)  NOT NULL,
    author_id      BINARY(36)  NULL,
    type_id        BINARY(36)  NOT NULL,
    title          VARCHAR(40) NOT NULL,
    image          VARCHAR(30) NULL,
    question_count INT         NULL,
    CONSTRAINT tests_title_key UNIQUE (title),
    CONSTRAINT tests_author_id_fk FOREIGN KEY (author_id) REFERENCES users (id)
        ON DELETE CASCADE
        ON UPDATE CASCADE,
...
(
    id          BINARY(36) PRIMARY KEY,
    question_id BINARY(36)  NOT NULL,
